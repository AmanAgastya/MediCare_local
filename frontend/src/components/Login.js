...
import { UserCircle, Hospital, Stethoscope } from 'lucide-react';
import './Login.css';
...
const LoginPage = () => {
  return (
    <div className="login-container">
      ...
      <div className="login-section doctor-section">
        <div className="login-content">
          <Stethoscope size={48} color="#4a90e2" />
          <h2>For Doctors</h2>
          <p>Login with the credentials provided by your hospital admin to access your appointments and patient queue.</p>
          <button className="login-button-n doctor" onClick={() => window.location.href = '/doctor-login'}>Doctor Login</button>
          <div className="signup-text">
            <p>No credentials?</p>
            <div className="signup-links">
              <a href="mailto:support@example.com">Contact your Hospital Admin</a>
            </div>
          </div>
        </div>
      </div>
